        ...
        <div className="container-arena text-center">
          ...
          once: true
            ...
            <p className="text-secondary-foreground/70 text-lg max-w-3xl mx-auto">
              Nosso bar é o lugar perfeito para relaxar depois do jogo, encontrar os amigos ou simplesmente curtir uma tarde com drinks gelados e boa música. Cardápio completo com drinks, chopp, cervejas e porções deliciosas.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-arena">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {menuCategories.map((category, catIndex) => <motion.div key={category.title} initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            delay: catIndex * 0.1
                ...
                <div className="space-y-4">
                  {category.items.map(item => <div key={item.name} className="flex justify-between items-center border-b border-border pb-3 last:border-0">
