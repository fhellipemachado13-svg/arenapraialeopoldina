...
const courts = [
  { id: 1, name: "Quadra 1", available: true },
  { id: 2, name: "Quadra 2", available: true },
  { id: 3, name: "Quadra 3", available: false },
  { id: 4, name: "Quadra 4", available: true },
  { id: 5, name: "Quadra 5", available: true },
  { id: 6, name: "Quadra 6", available: false },
];

const features = [
  { icon: MapPin, title: "6 Quadras", desc: "Quadras de areia profissionais" },
  { icon: Users, title: "Multiuso", desc: "Beach Tennis, Futevôlei, Vôlei" },
  { icon: Trophy, title: "Eventos", desc: "Campeonatos e torneios" },
  { icon: Clock, title: "Horário", desc: "Das 8h às 23h" },
];
    ...
    <Layout>
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            QUADRAS & <span className="text-primary">AGENDAMENTOS</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="gradient" size="xl" asChild>
                <a
                  href={`https://wa.me/5511999999999?text=Olá! Gostaria de reservar ${selectedCourt ? `a Quadra ${selectedCourt}` : "uma quadra"} na Arena Praia Leopoldina.`}
                  target="_blank"
      ...
      <section className="section-padding bg-secondary">
        <div className="container-arena text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { title: "Jogos entre amigos", desc: "Marque aquele racha com a turma" },
              { title: "Treinos", desc: "Espaço ideal para sua evolução" },
              { title: "Campeonatos", desc: "Eventos e torneios personalizados" },
            ].map((item) => (
