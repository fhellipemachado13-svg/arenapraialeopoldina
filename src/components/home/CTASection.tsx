...
const CTASection = () => {
  ...
  return <section className="section-padding" ref={ref}>
      <div className="container-arena">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          duration: 0.6
            ...
            <div className="aspect-[16/10] relative">
              <img src={barImage} alt="Bar da Arena" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
          ...
          delay: 0.2
            ...
            <div className="aspect-[16/10] relative">
              <img src={musicImage} alt="Música ao vivo" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
              <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-black/40" />
        ...
        delay: 0.4
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-lg mb-8 max-w-xl mx-auto">Oferecemos aulas de Beach Tennis e Futevôlei para iniciantes, intermediários e avançados. Turmas com horários flexíveis!</p>
